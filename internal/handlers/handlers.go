...
import (
	...
	"github.com/HeadBangZ/bookings/internal/repository/dbrepo"
)
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	m.sendEmailNotificationAndConfirmation(reservation.Email, "me@here.com", "Reservation Confirmation", htmlMessage)

	// Send notifications - first to guest
	htmlMessage = fmt.Sprintf(`
	<strong>Reservation Notification</strong><br>
	A reservation has been made from %s to %s by %s %s.
`, reservation.StartDate.Format("2006-01-02"), reservation.EndDate.Format("2006-01-02"), reservation.FirstName, reservation.LastName)

	m.sendEmailNotificationAndConfirmation("me@here.com", "me@here.com", "Reservation Notification", htmlMessage)
...
// SendEmail Confirmation and Notification
func (m *Repository) sendEmailNotificationAndConfirmation(to, from, subject, htmlMessage string) {
	msg := models.MailData{
		To:       to,
		From:     from,
		Subject:  subject,
...
// PostShowLogin handles login for user
